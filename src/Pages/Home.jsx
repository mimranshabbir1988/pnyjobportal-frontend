...

                  {
                    result.length > 0 ? (
                      <div className='flex justify-center mt-4 space-x-8'>
                        <button onClick={prevPage} className='hover:underline bg-slate-600 rounded-sm text-white px-2 py-1' disabled={currentPage === 1}>Previous</button>
                        ...
                        <button onClick={nextPage} className='hover:underline bg-slate-600 rounded-sm text-white px-2 py-1' disabled={currentPage === Math.ceil(filteredItems.length / itemsPerPage)}>Next</button>
                      </div>
                    ) : " "
                  }
